				   ...
				   <!--<div class="card"> --> 
					  ...
					  <!-- USER DATA-->
                                <div class="user-data m-b-30">
								  ...
								  <a href="farmer_view.jsp" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i>Back</a></h3>
...
<table width="721" class="table">
  ...
  <%
	...
	ResultSet rs=s.stm.executeQuery("select * from land_details l,farmer_details f where l.f_id=f.f_id and f.f_id='"+fid+"'");
	while(rs.next())
	{
