  ...
  <form id="WFS_Riz" name="form1" method="post" action="landinsert.jsp">
   <div class="row form-group">
	 ...
	 <div class="col col-md-2"><label for="text-input" class="form-control-label">Land Size</label></div>
	  <div class="col-12 col-md-10">
	<input class="validate[required,custom[onlyNumber] form-control" name="ls" type="text" id="ls">
	</div>
    </div>
	...
	<input class="validate[required,custom[onlyLetter]] form-control" name="st" type="text" id="st">
	 ...
	 <div class="col col-md-2"><label for="text-input" class="form-control-label">Water Resource</label></div>
	  <div class="col-12 col-md-10">
   <input class="validate[required,custom[onlyLetter]] form-control" name="wr" type="text" id="wr">
    <!-- Here -->
		 </div>
	  </div>
