				 ...
				 <div class="col-md-12">
				   <div class="card">
					 ...
					 <div class="card-header">
                                        <strong>Scheme Applied </strong> Details
                                    </div>
...
<div class="row form-group">
    ...
    %>
	 ...
	 <div class="col col-md-2"><label for="text-input" class="form-control-label">Farmer</label></div>
	    <div class="col-12 col-md-10">
        <select class="validate[required] form-control" name="fi"  id="fi">
    ...
    %>
      ...
      <div class="row form-group">
	 <div class="col col-md-2"><label for="text-input" class="form-control-label">Scheme Applyed Date</label></div>
	    <div class="col-12 col-md-10"><input class="validate[required,custom[date]] form-control" name="sd" type="text" id="sd">
      </div>
    </div>
	
      <div class="row form-group">
	 <div class="col col-md-2"><label for="text-input" class="form-control-label">Status</label></div>
	    <div class="col-12 col-md-10"><input class="validate[required] form-control" name="ss" type="text" id="ss">
       </div>
    </div>
