				 ...
				 <div class="col-md-12">
				   <div class="card">
					 ...
					 <div class="card-header">
                                        <strong>Select & Upload Photo <a onclick="return confirm('Are you sure?')" href="myprofile.jsp" class="btn btn-danger btn-sm">Cancel</a></strong>
                                    </div>
                                    <div class="card-body card-block">

<jsp:include page="val.jsp"></jsp:include>
<form id="WFS_Riz" name="form1" method="post" enctype="multipart/form-data" action="farmer_upload_photo.jsp">
