                        ...
                        <div class="header-wrap">
                           <form class="form-header" action="#" method="POST">
                            ...
                            <div class="header-button">
								...
								rs.next();
								String pht=rs.getString("f_photo");
								String nm=rs.getString("f_name")+" "+rs.getString("f_lname");
							%>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <strong><%=nm%></strong> | <a onClick="return confirm('Are you sure?')" href="../logout.jsp" title="Logout">Logout</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">Farmer Panel</span>
                                                </div>
                                            </div>
